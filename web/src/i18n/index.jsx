...
const DICT = {
  fr: {
    ...
    'nav.marketing': 'Matériel marketing',
    'nav.offers': 'Offres de services',
    'nav.toolkit': 'Trousse client',
  ...
  en: {
    ...
    'sec.promo': 'Marketing',
    'nav.marketing': 'Marketing material',
    'nav.offers': 'Service offers',
    'nav.toolkit': 'Client toolkit',
    'sec.crm': 'Contacts (CRM)',
    'nav.contacts': 'Contacts',
